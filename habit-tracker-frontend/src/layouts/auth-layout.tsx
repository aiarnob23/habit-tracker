  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-[#07172e] text-white">
      ...
      <div className="absolute inset-0">
        <div className="absolute -left-40 bottom-0 h-105 w-105 rounded-full bg-blue-500/20 blur-[130px]" />

        <div className="absolute right-0 top-20 h-95 w-95 rounded-full bg-indigo-500/20 blur-[140px]" />

        <div className="absolute bottom-0 right-40 h-75 w-75 rounded-full bg-cyan-400/10 blur-[120px]" />
